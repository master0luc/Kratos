...
namespace Kratos
{
	...
	// For projection and CAD-reconstruction quality evaluation 
	KRATOS_CREATE_VARIABLE( double, POSITIONAL_DEVIATION );	
	KRATOS_CREATE_VARIABLE( double, VTK_DUMMY );	
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PROJECTION_DISTANCE_TO_QK);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_QK);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_Q);
	KRATOS_CREATE_VARIABLE( int, PATCH_ID_OF_QK);
	KRATOS_CREATE_VARIABLE( int, PATCH_ID_OF_Q);
	KRATOS_CREATE_VARIABLE( bool, INSIDE_TRIMMING_BOUNDARY_QK);
	KRATOS_CREATE_VARIABLE( bool, INSIDE_TRIMMING_BOUNDARY_Q);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_VARIABLE(VTK_DUMMY)
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PROJECTION_DISTANCE_TO_QK);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_QK);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_Q);
        KRATOS_REGISTER_VARIABLE(PATCH_ID_OF_QK)
        KRATOS_REGISTER_VARIABLE(PATCH_ID_OF_Q)
        KRATOS_REGISTER_VARIABLE(INSIDE_TRIMMING_BOUNDARY_QK)
        KRATOS_REGISTER_VARIABLE(INSIDE_TRIMMING_BOUNDARY_Q)
