...
namespace Kratos
{
	...
	KRATOS_DEFINE_VARIABLE( double, VTK_DUMMY );	
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(PROJECTION_DISTANCE_TO_QK);
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_QK);
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_Q);
	KRATOS_DEFINE_VARIABLE( int, PATCH_ID_OF_QK);
	KRATOS_DEFINE_VARIABLE( int, PATCH_ID_OF_Q);
	KRATOS_DEFINE_VARIABLE( bool, INSIDE_TRIMMING_BOUNDARY_QK);
	KRATOS_DEFINE_VARIABLE( bool, INSIDE_TRIMMING_BOUNDARY_Q);
