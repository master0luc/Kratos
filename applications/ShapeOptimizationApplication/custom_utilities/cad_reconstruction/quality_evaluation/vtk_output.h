...
class VtkOutput
{
  ...
  public:
    ...
    /// Default constructor.
    VtkOutput(ModelPart &model_part, std::string outPutFileName, Parameters rParameters)
        : mr_model_part(model_part),
          mOutputFilename(outPutFileName),
          mrOutputSettings(rParameters)
    {
    ...
    void writeFirstNodalResultsAsPointData(ModelPart &model_part)
    {
        ...
        Parameters nodalResults = this->mrOutputSettings["nodal_results"];
    ...
    void PrintOutputSubModelPart(ModelPart &modelPart)
    {
        ...
        std::string type = this->mrOutputSettings["vtk_type"].GetString();
        if (type == "Binary")
        {
            initialize(modelPart);
