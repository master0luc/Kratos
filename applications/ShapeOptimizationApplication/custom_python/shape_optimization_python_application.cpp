...
namespace Python
{
  ...
  BOOST_PYTHON_MODULE(KratosShapeOptimizationApplication)
  {
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(POSITIONAL_DEVIATION);	
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(VTK_DUMMY);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(PROJECTION_DISTANCE_TO_QK);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_QK);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(RECONSTRUCTION_DISTANCE_TO_Q);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(PATCH_ID_OF_QK);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(PATCH_ID_OF_Q);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(INSIDE_TRIMMING_BOUNDARY_QK);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(INSIDE_TRIMMING_BOUNDARY_Q);
  }
