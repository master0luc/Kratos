...
//         noalias( rLeftHandSideMatrix ) = ZeroMatrix( MatrixSize, MatrixSize ); // Resetting LHS // TODO: Check if remove it or not
    }
...
//         noalias(rRightHandSideVector) = ZeroVector( MatrixSize ); // Resetting RHS
    }
}
