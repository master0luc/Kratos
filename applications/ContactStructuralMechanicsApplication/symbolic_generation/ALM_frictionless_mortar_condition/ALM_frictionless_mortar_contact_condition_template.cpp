...
{
    return Condition::Pointer( new AugmentedLagrangianMethodFrictionlessMortarContactCondition<TDim,TNumNodes, TNormalVariation >( NewId, this->GetGeometry().Create( rThisNodes ), pProperties ));
}
